...
export default function Home() {
  const saleProducts = getProductsByCategory('watches').slice(0, 6);
  const watchProducts = getProductsByCategory('watches').slice(0, 4);
  const beltProducts = getProductsByCategory('belts').slice(0, 4);
  const walletProducts = getProductsByCategory('wallets').slice(0, 4);
  const mensProducts = getProductsByCategory('mens-accessories').slice(0, 4);
      ...
      <section className="hero-banner py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            <div className="mb-8">
              <img
                src="https://images.unsplash.com/photo-1607082348824-0e671340044d?w=800&h=400&fit=crop"
